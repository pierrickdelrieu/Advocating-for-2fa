<template>
    <div id="register">
      <Form @submit="handleRegister" :validation-schema="schema">
        ...
        <div class="form-item">
          <label for="passwordConfirmation">Confirm Password <strong>*</strong></label><br>
          <Field type="password" id="passwordConfirmation" name="passwordConfirmation" placeholder="Confirm password" /><br>
        ...
        <div classname="error-feedback" v-if="message">{{ message }}</div>
      </Form>
